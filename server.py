...
Endpoints (OpenEnv standard):
  ...
  GET  /state        — return full EpisodeState
  GET  /tasks        — list available task IDs
  POST /grade        — compute final score for current episode

Query param: ?task=easy|medium|hard  (default: easy)
"""
...
# One env instance per task (simple server-side state; fine for hackathon scale)
